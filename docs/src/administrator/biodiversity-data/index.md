...
* **[Harvest External Taxonomy from WoRMS:](harvest-external-taxonomy-from-worms.md)** This section explains how to import taxonomy from the World Register of Marine Species (WoRMS) into BIMS by providing a parent AphiaID, allowing the system to recursively harvest all accepted child taxa and link them to a taxon group.
* **[Harvest External Taxonomy from TaxonWorks:](harvest-external-taxonomy-from-taxonworks.md)** This section explains how to import taxonomy from a TaxonWorks instance into BIMS by providing the instance URL, a project token, and a root taxon ID, allowing the system to recursively harvest the full subtree and link taxa to a taxon group.
* **[Checklist Version Workflow:](checklist-version-workflow.md)** This section explains how to create, publish, and manage versioned, citable checklists for each biological module, including exporting ColDP ZIP packages for submission to ChecklistBank.
* **[Meta Groups:](meta-groups.md)** This section explains how to create and manage Meta Groups, which are broad organism categories used to group related Taxon Groups together for filtering and display purposes.
